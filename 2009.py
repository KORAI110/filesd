...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/KORAI110/lush/blob/main/lush.txt"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/KORAI110/lush/blob/main/lush.txt').text
			if basesplit in plr:
				key = basesplit
